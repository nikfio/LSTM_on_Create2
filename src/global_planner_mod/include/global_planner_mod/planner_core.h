#ifndef _PLANNERCORE_MOD_H
#define _PLANNERCORE_MOD_H
...
#include <global_planner_mod/orientation_filter.h>
#include <global_planner_mod/GlobalPlannerModConfig.h>
...
class GlobalPlanner : public nav_core::BaseGlobalPlanner {
    ...
    private:
        ...
        dynamic_reconfigure::Server<global_planner_mod::GlobalPlannerModConfig> *dsrv_;
        void reconfigureCB(global_planner_mod::GlobalPlannerModConfig &config, uint32_t level);
