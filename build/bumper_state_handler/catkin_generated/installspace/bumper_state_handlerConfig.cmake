...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bumper_state_handler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nikfio/Documents/ThesisCode/NN-Roomba/RealEnv/install/${idir}'.  Ask the maintainer 'nikfio <nikfio@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nikfio/Documents/ThesisCode/NN-Roomba/RealEnv/install/lib;/home/nikfio/bin/roombs-robot-pkgs/devel/lib;/opt/ros/jade/lib)
