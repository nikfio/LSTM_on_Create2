...
if("FALSE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /home/leonida/ThesisCode/LSTM_on_Create2/src/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /home/leonida/ThesisCode/LSTM_on_Create2/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /home/leonida/ThesisCode/LSTM_on_Create2/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'nikfio <nikfio@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leonida/ThesisCode/LSTM_on_Create2/install/${idir}'.  Ask the maintainer 'nikfio <nikfio@todo.todo>' to fix it.")
    endif()
